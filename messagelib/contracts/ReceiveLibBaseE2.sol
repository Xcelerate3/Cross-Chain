...
import { IXcelerateEndpointV2, Origin } from "@xcelerate/lz-evm-protocol-v2/contracts/interfaces/IXcelerateEndpointV2.sol";
import { IMessageLib, MessageLibType } from "@xcelerate/lz-evm-protocol-v2/contracts/interfaces/IMessageLib.sol";
import { PacketV1Codec } from "@xcelerate/lz-evm-protocol-v2/contracts/messagelib/libs/PacketV1Codec.sol";
...
abstract contract ReceiveLibBaseE2 is MessageLibBase, ERC165, IMessageLib {
    ...
    constructor(address _endpoint) MessageLibBase(_endpoint, IXcelerateEndpointV2(_endpoint).eid()) {}
