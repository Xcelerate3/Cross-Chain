...
import { ExecutorOptions } from "@xcelerate/lz-evm-protocol-v2/contracts/messagelib/libs/ExecutorOptions.sol";

import { IXceleratePriceFeed } from "./interfaces/IXceleratePriceFeed.sol";
...
contract ExecutorFeeLib is Ownable, IExecutorFeeLib {
    ...
    function getFeeOnSend(
        ...
        ) = IXceleratePriceFeed(_params.priceFeed).estimateFeeOnSend(_params.dstEid, _params.calldataSize, totalGas);
    ...
    function getFee(
        ...
        (
            ...
            uint128 priceRatioDenominator,
            uint128 nativePriceUSD
        ) = IXceleratePriceFeed(_params.priceFeed).estimateFeeByEid(_params.dstEid, _params.calldataSize, totalGas);
