...
import { IXcelerateEndpointV2, MessagingFee } from "@xcelerate/lz-evm-protocol-v2/contracts/interfaces/IXcelerateEndpointV2.sol";
import { IMessageLib, MessageLibType } from "@xcelerate/lz-evm-protocol-v2/contracts/interfaces/IMessageLib.sol";
import { ISendLib, Packet } from "@xcelerate/lz-evm-protocol-v2/contracts/interfaces/ISendLib.sol";
import { Transfer } from "@xcelerate/lz-evm-protocol-v2/contracts/libs/Transfer.sol";
...
abstract contract SendLibBaseE2 is SendLibBase, ERC165, ISendLib {
    ...
    ) SendLibBase(_endpoint, IXcelerateEndpointV2(_endpoint).eid(), _treasuryGasLimit, _treasuryNativeFeeCap) {}
    ...
    function withdrawFee(address _to, uint256 _amount) external {
        _debitFee(_amount);
        address nativeToken = IXcelerateEndpointV2(endpoint).nativeToken();
    ...
    function withdrawLzTokenFee(address _lzToken, address _to, uint256 _amount) external {
        ...
        if (IXcelerateEndpointV2(endpoint).nativeToken() == _lzToken) revert LZ_MessageLib_CannotWithdrawAltToken();
